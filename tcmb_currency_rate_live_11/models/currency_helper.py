...
class CurrencyHelper:
    ...
    def get_rates_on_date(self, date, currency, company_currency="TRY"):
        ...
        if response.status_code == 200:
            ...
            rate = float(base_currency_rate) / float(currency_node[0][3])
            ...
            banknot_selling_rate = float(base_currency_rate) / float(currency_node[0][1])
            ...
            if len(currency_node):
                return {
                    "banknote_selling": banknot_selling_rate,
